...
#                        STOP
                        ...
                        filename = "file_Bhaskarian_pulse_pulse_40_site_"+str(kicks[0])+"_site_"+str(kicks[1])+"_site_"+str(kicks[2])+"_site_"+str(kicks[3])+"_site_"+str(kicks[4])+"_site_"+str(kicks[5])+"_site_"+str(kicks[6])+"_L_"+str(L)+"_40_pulses_In_Bhaskarian_pulse_site_1_hz_"+str(hz)+"_phi_"+str(phi)+"_tau_"+str(tau)+"_maxdim_"+str(maxdim)+"_numkicks_"+str(numkick)+"_Ntau_"+str(N_tau)
                        f = open(filename, 'w')
                        f.write("L="+str(L)+"\n")
                        ...
                        f.write("cutoff=10^(-8)\n")
                        f.write("file_name=\"OPEN_Bhaskarian_pulse_pulse_40_site_"+str(kicks[0])+"_site_"+str(kicks[1])+"_site_"+str(kicks[2])+"_site_"+str(kicks[3])+"_site_"+str(kicks[4])+"_site_"+str(kicks[5])+"_site_"+str(kicks[6])+"_output_with_effective_ham_double_S_experiment_1_site_1_kicked_L_"+str(L)+"__hz_"+str(hz)+"_phi_"+str(phi)+"_tau_"+str(tau)+"_maxdim_"+str(maxdim)+"_numkicks_"+str(numkick)+"_Ntau_"+str(N_tau)+"\"\n")
                        ...
                        j.write("julia square_beta_tebd.jl "+str(filename)+" > "+"OPEN_pipe_out_OPEN_Bhaskarian_pulse_pulse_40_site_"+str(kicks[0])+"_site_"+str(kicks[1])+"_site_"+str(kicks[2])+"_site_"+str(kicks[3])+"_site_"+str(kicks[4])+"_site_"+str(kicks[5])+"_site_"+str(kicks[6])+"_kicked_L_"+str(L)+"__hz_"+str(hz)+"_phi_"+str(phi)+"_tau_"+str(tau)+"_maxdim_"+str(maxdim)+"_numkicks_"+str(numkick)+"_Ntau_"+str(N_tau))
                        j.close()
