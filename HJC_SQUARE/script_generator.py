...
#                        STOP
                        ...
                        f.close()
                        os.system("julia square_beta_tebd.jl "+str(filename)+" > RONSLURM_10_output_with_effective_ham_double_S_experiment_1_site_1_kicked__hz_"+str(hz)+"_phi_"+str(phi)+"_tau_"+str(tau))
